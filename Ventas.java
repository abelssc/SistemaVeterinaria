...
public class Ventas extends JPanel {
	...
	public Ventas() {
		...
		panel.setBackground(new Color(150,150,150,80));
		add(panel);
		...
		lblRuc.setBorder(new LineBorder(Color.RED, 1, true));
		...
		////////////////////////////////////////////////////JUST LBS less IMPORTANT
		JLabel lblNewLabel = new JLabel("Fecha");
		lblNewLabel.setFont(new Font("JetBrainsMono Nerd Font Mono", Font.PLAIN, 14));
		...
		rdbtnBoleta.setBounds(565, 130, 109, 20);
		...
		rdbtnFactura.setBounds(565, 150, 109, 20);
		...
		lblTipoDeComprobante.setBounds(560, 100, 200, 30);
		panel.add(lblTipoDeComprobante);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(10, 300, 1240, 420);
		add(panel_1);
		panel_1.setBackground(new Color(150,150,150,80));
		...
		scrollPane.getViewport().setBackground(new Color(150,150,150,80));
		...
		lbltxtsb.setBorder(new LineBorder(Color.RED, 1, true));
		...
		lblSubTotal.setBorder(new MatteBorder(1, 0, 1, 1, (Color) Color.RED));
		...
		lbltxtigv.setBorder(new LineBorder(Color.RED, 1, true));
		...
		lbligv.setBorder(new MatteBorder(1, 0, 1, 1, (Color) Color.RED));
		...
		lbltxtt.setBorder(new LineBorder(Color.RED, 1, true));
		...
		lblIconoGenerarVenta.setIcon(new ImageIcon(Ventas.class.getResource("/imagenes/venta.png")));
